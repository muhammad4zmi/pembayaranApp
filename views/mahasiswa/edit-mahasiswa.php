                ...
                <?php foreach ($Query as $p) : ?>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nim" class="form-control" autofocus style="font-size: 12px;" placeholder="Masukkan nim" required value="<?= $p['nim']; ?>">

                                </div>
                                <div class="form-group">

                                    <label for="nama" style="font-size: 12px;">Tempat Lahir *</label>
                                    <input type="text" name="tempat_lahir" class="form-control" autofocus style="font-size: 12px;" placeholder="Masukkan tempat lahir" required value="<?= $p['tempatlahir']; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control" style="font-size: 12px;" placeholder="Masukkan nama Sesuai KK" required value="<?= $p['nama']; ?>">

                                </div>
                                <div class="form-group">
                                    <label for="nama" style="font-size: 12px;">Tanggal Lahir *</label>
                                    <input type="text" name="tgl_lahir" class="form-control" style="font-size: 12px;" placeholder="Masukkan tanggal lahir" data-provide="datepicker" id="tgl_lahir" required value="<?= $p['tgl_lahir']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="prodi" id="" class=" form-control" style="font-size: 12px;" required>
                                        ...
                                        foreach ($prodi as $d) : ?>
                                            <option value="<?= $p['prodi']; ?>" <?php if (isset($p['prodi'])) {
                                                                                    if ($d['kodeprodi'] == $p['prodi']) {
                                                                                        echo "selected";
                                                                                    }
                                                                                } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" class=" form-control" style="font-size: 12px;"><?= $p['alamat']; ?></textarea>
